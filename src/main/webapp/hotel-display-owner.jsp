			...
			<tr>
				...
				<td>
					<div class="d-flex align-items-center">
						<img src="data:image/png;base64,<%=encodeImage%>" alt="hotel-image"
				...
				<td>
					<td><a href="#"><span class="badge badge-success rounded-pill d-inline">EDIT</a></span>
				</td>
				    <td><a href="#"><span class="badge badge-danger rounded-pill d-inline">DELETE</a></span>
				</td>
			</tr>
		</tbody>
		<%}%>
